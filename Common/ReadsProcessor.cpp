...
static const char revTable[256] = {
	...
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //3
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 'T', 0x00, 'G', 0x00, 0x00, 0x00, 'C', //4 A C G
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 'A', 0x00, 0x00, 0x00, //5 T
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 'T', 0x00, 'G', 0x00, 0x00, 0x00, 'C', //6 a c g
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 'A', 0x00, 0x00, 0x00, //7 t
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //8
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //9
...
static const char fwTableSulf[256] = {
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //0
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //1
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	...
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //3
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 'A', 0x00, 'T', 0x00, 0x00, 0x00, 'G', //4 A C G
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 'T', 0x00, 0x00, 0x00, //5 T
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 'A', 0x00, 'T', 0x00, 0x00, 0x00, 'G', //6 a c g
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 'T', 0x00, 0x00, 0x00, //7 t
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //8
...
static const char revTableSulf[256] = {
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //0
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //1
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	...
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //3
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 'T', 0x00, 'G', 0x00, 0x00, 0x00, 'T', //4 A C G
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 'A', 0x00, 0x00, 0x00, //5 T
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 'T', 0x00, 'G', 0x00, 0x00, 0x00, 'T', //6 a c g
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 'A', 0x00, 0x00, 0x00, //7 t
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //8
...
const string &ReadsProcessor::prepSeq(string const &sequence, size_t position) {
	...
	for (; outputIndex < halfKmerSize; ++index) {
		//modify the forward

		outputFwd[outputIndex] = fwTable[sequence[index]];
		outputRev[outputIndex] = revTable[sequence[revIndex]];
		if (outputFwd[outputIndex] == 0x00 || outputRev[outputIndex] == 0x00) {
			return emptyResult;
		}
...
/* Only for bisulfite treated sequences, intentionally changes all c to t's
 * Prepares DNA sequence for insertion into bloom filter by:
 * - Turning all lower-case sequences to upper-case
 * - Also looks into reverse compliment version and returns consistently
 *   that which is smaller (convention used A<C<G<T, i.e. alphabetical)
 ...
 * requires a start position
 */
const string &ReadsProcessor::prepSeqBisulf(string const &sequence, size_t position) {
	...
	for (; outputIndex < halfKmerSize; ++index) {
		...
		outputFwd[outputIndex] = fwTableSulf[sequence[index]];
		outputRev[outputIndex] = revTableSulf[sequence[revIndex]];
		if (outputFwd[outputIndex] == 0x00 || outputRev[outputIndex] == 0x00) {
			return emptyResult;
		}
